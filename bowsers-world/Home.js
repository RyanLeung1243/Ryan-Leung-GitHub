...
class Home extends React.Component { 
    ...
    scrollStep() {
      ...
      //button when pressed for back to top
      scroll() {
        ...
        return (          
            ...
            <button href='#' title='Back to top' 
               ...
               onClick={ (event) => { 
                ...
                <p><b>Pick a topic: </b><input type="text" onChange ={this.handleChange} onKeyDown={this.handleKeyDown} placeholder="Search Articles"></input>
                ...
                {this.state.articles.map((article, index) => (
                    <div className='article' key={index}>
                        ...
                        <p>Written by: {article.author} - Source: <a href={`http://www.${article.source.name}`} target='_blank' rel="noopener noreferrer">{article.source.name}</a></p>
