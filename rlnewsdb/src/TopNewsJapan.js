...
const BASE_URL  = 'https://newsapi.org/v2/top-headlines?country=jp&apiKey='
                + API_KEY + "&q=";
...
class TopnewsJapan extends React.Component { 
    constructor() {
        super();
        this.state  = {
          apiKey : API_KEY,
