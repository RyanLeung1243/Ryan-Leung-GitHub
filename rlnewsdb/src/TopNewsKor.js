...
const BASE_URL  = 'https://newsapi.org/v2/top-headlines?country=kr&apiKey='
                + API_KEY + "&q=";
...
class TopnewsKor extends React.Component { 
    constructor() {
        super();
        this.state  = {
          apiKey : API_KEY,
    ...
    render() {
        return (          
            ...
            <h1>SOUTH KOREA - TOP HEADLINES</h1>
