...
const BASE_URL  = 'https://newsapi.org/v2/top-headlines?country=ru&apiKey='
                + API_KEY + "&q=";
...
class TopnewsRus extends React.Component { 
    constructor() {
        super();
        this.state  = {
          apiKey : API_KEY,
