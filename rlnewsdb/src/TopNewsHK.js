...
const BASE_URL  = 'https://newsapi.org/v2/top-headlines?country=hk&apiKey='
                + API_KEY + "&q=";
...
class TopnewsHK extends React.Component { 
    constructor() {
        super();
        this.state  = {
          apiKey : API_KEY,
