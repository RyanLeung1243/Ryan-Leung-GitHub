...
const BASE_URL  = 'https://newsapi.org/v2/top-headlines?country=de&apiKey='
                + API_KEY + "&q=";
...
class TopnewsGer extends React.Component { 
    constructor() {
        super();
        this.state  = {
          apiKey : API_KEY,
