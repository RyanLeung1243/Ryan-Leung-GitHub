...
const BASE_URL  = 'https://newsapi.org/v2/top-headlines?country=cn&apiKey='
                + API_KEY + "&q=";
...
class TopnewsChina extends React.Component { 
    constructor() {
        super();
        this.state  = {
          apiKey : API_KEY,
