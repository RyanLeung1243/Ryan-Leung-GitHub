...
const BASE_URL  = 'https://newsapi.org/v2/top-headlines?country=gb&apiKey='
                + API_KEY + "&q=";
...
class TopnewsUK extends React.Component { 
    constructor() {
        super();
        this.state  = {
          apiKey : API_KEY,
    ...
    render() {
        return (          
            ...
            <h1>UNITED KINGDOM - TOP HEADLINES</h1>
                ...
                {this.state.articles.map((article, index) => (
                    <div className='article' key={index}>
                        ...
                        <p>By: {article.author} - Source: <a href={`http://${article.source.name}`} target='_blank' rel="noopener noreferrer">{article.source.name}</a></p>
